...
const Home = () => {
    ...
    return (
      ...
      <div className="loading">
          ...
          result.startsWith('arn:aws:lambda:') ? 
          ...
          <div>This library has thrown errors on creation. We are working on allowing more to be created. Sorry for the inconvenience</div> 
          }
          </div>
          <br></br>
          <br></br>
